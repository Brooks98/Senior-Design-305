...
float dirServoOffset = -2;         // define a variable for deviation(degree) of the servo
int turn = 0;
...
//    Serial.print("\t");
    ...
    newspeed = map(newspeed, 0, 512, 0, 200);
...
//    Serial.print("\n");
    ...
    turn = constrain(turn, -40, 40);
    turn = map(turn, -40, 40, 45 ,135 );
...
//    Serial.print("\n");
  ...
  {
    digitalWrite(RPin, HIGH);digitalWrite(GPin, LOW);digitalWrite(BPin, HIGH); //pretty colors
  }
  //delay(5);
}
